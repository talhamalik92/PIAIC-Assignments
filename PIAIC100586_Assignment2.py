...
def function3():
	...
	#example [35,70,105,..]
	a = np.arange(1, 100*10+1).reshape((100,10)).flatten()
	x = [elem for elem in a if (elem%5 == 0 and elem%7 ==0)] #wrtie your code here
	return x
	"""
	Expected Output:
...
def function4():
	...
	arr[:,[0, 1]] = arr[:,[1, 0]]
	return np.array(arr) #wrtie your code here
	"""
	Expected Output:
		  array([[1, 0, 2],
				[4, 3, 5],
...
def function13():
	...
	ans = np.array([x for x in arr if x in range(5, 10)])#write your code here 
...
def function17():
	...
	return  np.array([['NO', 'NO', 'NO', 'NO', 'NO', 'NO', 'NO', 'NO', 'NO', 'NO'],
...
def function20():
	...
	return np.array([abc(x) for x in arr])#Write your Code here
